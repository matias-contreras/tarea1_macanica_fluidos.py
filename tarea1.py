...
plt.plot(b2_japo_x_este, b2_japo_x_norte, label='Japonés manual')
plt.plot(b2_ale_x_este, b2_ale_x_norte, label='Alemán manual')
plt.legend()
...
plt.plot(b1_japo_x_este, b1_japo_x_norte, label='Japonés manual')
plt.plot(b1_ale_x_este, b1_ale_x_norte, label='Alemán manual')
plt.legend()
...
plt.title('Ángulos azimutales del teodolito alemán del bloque de las 9:39 am')
plt.xlabel('Tiempo [segundos]')
plt.ylabel(r' $\phi$ [rad]')
...
plt.title('Ángulos de elevación del teodolito alemán del bloque de las 9:39 am')
plt.xlabel('Tiempo [segundos]')
plt.ylabel(r' $\theta$ [rad]')
...
plt.title('Ángulos azimutales del teodolito alemán del bloque de las 10:57 am')
plt.xlabel('Tiempo [segundos]')
plt.ylabel(r' $\phi$ [rad]')
...
plt.title('Ángulos de elevación del teodolito alemán del bloque de las 10:57 am')
plt.xlabel('Tiempo [segundos]')
plt.ylabel(r' $\theta$ [rad]')
...
plt.plot(velos_b1_ale[0], 3*tiempo[1:41], '*', label='Magnitud del viento')
...
plt.xlim(0, 6.3)
plt.grid()
plt.title('Perfil de altura con magnitud y dirección de velocidad del viento medido por el teodolito alemán desde las 9:39 am')
...
plt.plot(velos_b1_japo[0], 3*tiempo[1:41], '*', label='Magnitud del viento')
...
plt.plot(velos_b1_auto[0], 3*tiempo[1:41], '*', label='Magnitud del viento')
...
plt.plot(velos_b2_auto[0], 3*tiempo[1:41], '*', label='Magnitud del viento')
...
plt.plot(velos_b2_japo[0], 3*tiempo[1:41], '*', label='Magnitud del viento')
...
plt.plot(velos_b2_ale[0], 3*tiempo[1:41], '*', label='Magnitud del viento')
...
plt.xlim(0, 9.5)
plt.grid()
plt.title('Perfil de altura con magnitud y dirección de velocidad del viento medido por el teodolito alemán desde la 10:57 am')
plt.xlabel(r' Magnitud de la velocidad del viento $\left[\frac{m}{s}\right]$')
plt.ylabel('Altura [m]')
plt.legend()
